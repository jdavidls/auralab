...
from auralab.torch_cqt import cqt

def plot_torch_cqt(cqt_tensor: torch.Tensor, sr: int, hop_length: int, bpo: int, title: str = "CQT"):
    """
...
if __name__ == "__main__":
    ...
    # Plot
    plot_torch_cqt(C_torch, sr, hop_length, bins_per_octave, title="PyTorch CQT Magnitude")
